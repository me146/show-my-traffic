...
export const metadata: Metadata = {
  ...
  description: "Read BrainAITools's Privacy Policy to learn how we protected and managed your data and privateness spell using our services.",
  openGraph: {
...
export default async function PrivacyPolicy({
  ...
  const data = [
    ...
    },
    {
      key: "Company ",
      value:
        '(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to BrainAItools.',
    },
    {
      key: "Cookies",
      value:
    ...
    { key: "Country", value: "refers to: Gujarat, India" },
    {
      key: "Device",
      value:
    ...
    { key: "Service ", value: "refers to the Website." },
    {
    ...
    {
      key: "Website ",
      value: "refers to BrainAItools, accessible from",
      tag: "https://brainaitools.com.com/",
    },
    {
      key: "You ",
      value:
  ...
  const personData = [
    {
      ...
      value: "including to monitor the usage of our Service.",
    },
    {
  ...
  return (
    <main className="flex w-full flex-col flex-wrap h-auto gap-2 bg-white px-5 md:px-10">
      ...
      <div>Last updated: May 13, 2024</div>
      <div>
      ...
      <div className="text-[20px] lg:text-2xl font-semibold text-[#0B80E0] py-3">
        Interpretation and Definitions
      </div>
      <div className="text-[18px] lg:text-xl font-semibold">Interpretation</div>
      <p>
      ...
      <h3>Definitions</h3>
      <div className="text-[18px] lg:text-xl font-medium py-3">
        For the purposes of this Privacy Policy:
      </div>
      {data.map((cur: any, index: number) => (
        <div
          className="flex-row font-semibold ml-5 "
      ...
      <div className="text-[16px] lg:text-[18px] font-medium text-[#0B80E0]">
        Personal Data
      </div>
      <p>
      ...
      <p className="font-semibold ml-5 list-item">Email address</p>
      <p className="font-semibold ml-5 list-item">Usage Data</p>
      <div className="text-[16px] lg:text-[18px] font-medium text-[#0B80E0]">
        Usage Data
      </div>
      ...
      <div className="ml-5">
        <span className="font-semibold">Web Beacons</span> Certain sections of
      ...
      <p className="ml-5">
        ...
        <a
          href="https://termsfeed.com/blog/cookies/#What_Are_Cookies"
          target="_blank"
      ...
      <div className="ml-5 font-semibold">Necessary / Essential Cookies</div>
      <p className="ml-5">Type: Session Cookies</p>
      <p className="ml-5">Administered by: Us</p>
      <p className="ml-5">
      ...
      <p className="ml-5">Type: Persistent Cookies</p>
      <p className="ml-5">Administered by: Us</p>
      <p className="ml-5">
        Purpose: These Cookies identify if users have accepted the use of
        cookies on the Website.
      </p>
      <div className="ml-5 font-semibold">Functionality Cookies</div>
      <p className="ml-5">Type: Persistent Cookies</p>
      <p className="ml-5">Administered by: Us</p>
      <p className="ml-5">
      ...
      {personData.map((cur: any, index: number) => (
        <div
          className="flex-row font-semibold ml-5 list-item"
          key={`Personal Data ${index}`}
        >
          {cur.key}
          <span className="contents font-normal">{` - ${cur.value} `}</span>
        </div>
      ...
      {informationData.map((cur: any, index: number) => (
        <div
          className="flex-row font-semibold ml-5 list-item"
          key={`Personal Data ${index}`}
        >
      ...
      <div className="text-[16px] lg:text-[18px] font-medium ">Contact Us</div>
      <p>
