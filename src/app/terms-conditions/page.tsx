...
export const metadata: Metadata = {
  ...
  description: "Review the Terms and Conditions for using BrainAITools's services. Understand your rights and responsibilities as an user of our choline.",
  openGraph: {
...
export default async function TermsAndCondition({
  ...
  return (
    <main className="flex w-full flex-col flex-wrap h-auto gap-2 bg-white px-5 md:px-10">
      ...
      <p className="text-[18px] lg:text-xl font-medium py-3">
        For the purposes of these Terms and Conditions:
      </p>
      <p className="ml-5">
        <span className="flex-row font-semibold ">Affiliate</span> means an
      ...
      <p className="ml-5">
        <span className="flex-row font-semibold ">Country</span> refers to:
        Gujarat, India
      </p>
      <p className="ml-5">
        <span className="flex-row font-semibold">Company</span> (referred to as
        either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
        &quot;Our&quot; in this Agreement) refers to BrainAITools.
      </p>
      <p className="ml-5">
        <span className="flex-row font-semibold">Device</span> means any device
      ...
      <p className="ml-5">
        <span className="flex-row font-semibold">Terms and Conditions</span>{" "}
        ...
        use of the Service. This Terms and Conditions agreement has been created
        with the help of the{" "}
        <a
          href="https://termsfeed.com/terms-conditions-generator/"
          target="_blank"
        >
      ...
      <p className="ml-5">
        <span className="flex-row font-semibold">
      ...
      <p className="ml-5">
        <strong>Website</strong> refers to BrainAITools, accessible from{" "}
        <a
          href="https://brainaitools.com/"
          rel="external nofollow noopener"
          target="_blank"
          className="text-[#0373dd] border-b border-[#0373dd]"
        >
          https://brainaitools.com/
        </a>
      </p>
      <p className="ml-5">
        <span className="flex-row font-semibold">You</span> means the individual
      ...
      <h2 className="text-[18px] lg:text-xl font-medium py-3">Termination</h2>
      <p>
      ...
      <h2 className="text-[18px] lg:text-xl font-medium py-3">Governing Law</h2>
      <p>
      ...
      <div>
        <h3 className="text-[16px] ml-5 lg:text-[18px] font-medium text-[#0B80E0] list-item">
          Severability
        </h3>
        <p className="ml-5">
        ...
        <p className="ml-5">{`Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.`}</p>
      </div>
      <h2 className="text-[18px] lg:text-xl font-medium py-3">
